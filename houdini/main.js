...
// Links
var currentTarget = 'houdini';
houdiniLink.style.setProperty('border-color', 'rgb(255, 227, 100, 1.0)');
houdiniLinkMobile.style.setProperty('border-color', 'rgb(255, 227, 100, 1.0)');
